...
`.github/workflows/deploy.yml` is intentionally manual (`workflow_dispatch`) during development and runs from `main`. Repository Actions secrets required for the existing deploy workflow:
